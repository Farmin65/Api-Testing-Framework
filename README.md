...
![Pydantic](https://img.shields.io/badge/Pydantic-2.9.2-purple)
![License](https://img.shields.io/badge/License-MIT-yellow)
![CI](https://github.com/Farmin65/api-testing-framework/actions/workflows/tests.yml/badge.svg)
...
| Тестовый фреймворк | Pytest | 8.3.3 | Запуск и организация тестов |
| HTTP клиент | Requests | 2.32.3 | Выполнение HTTP запросов |
| Валидация данных | Pydantic | 2.9.2 | Контрактное тестирование и валидация схем |
| Конфигурация | Pydantic Settings | 2.5.2 | Управление настройками через .env |
| Генерация данных | Faker | 28.4.1 | Создание случайных тестовых данных |
| Отчеты | pytest-html | 4.1.1 | Генерация HTML отчетов |
| Отчеты | Allure Pytest | 2.13.5 | Расширенные Allure отчеты |
| Параллельный запуск | pytest-xdist | 3.6.1 | Распараллеливание тестов |
...
├─────────────────────────────────────────────────────────┤
│                    endpoints/                           │
│              (Методы API эндпоинтов)                     │
├─────────────────────────────────────────────────────────┤
│                       core/                             │
│     (HTTP клиент, ассерты, модели валидации)            │
├─────────────────────────────────────────────────────────┤
│                      config/                            │
│                (Настройки из .env)                       │
└─────────────────────────────────────────────────────────┘
